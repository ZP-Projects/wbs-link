# Disclaimer: early beta

- **This is an early-beta product and research challenge.** It is provided "as is", without warranty of any kind, and may change or be withdrawn at any time.
- **All challenge data is synthetic.** Any resemblance to real projects, companies or people is coincidental. Results on synthetic data don't predict results on real projects.
- **Never upload real project, client, employer or personal data** to this repository, its issues or its website. The health-check page runs entirely in your browser and doesn't transmit your files.
